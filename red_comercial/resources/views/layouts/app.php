        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUsers" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="{{url('products')}}">Users List</a>
                            <a class="collapse-item" href="utilities-color.html">Create User</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseCompanies" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Actions:</h6>
                            <a class="collapse-item" href="utilities-color.html">Companies List</a>
                            <a class="collapse-item" href="utilities-color.html">Create Company</a>
                        </div>
                    </div>
                </li>
                @endrole
