...
export const routesAdmin = [
    {
        ...
        name: 'clientes',
        path: '/admin/clientes/', props: true,
        component: ClientesList
    }, {
        name: 'clientesEditar',
        path: '/admin/cliente/:id', props: true,
        component: ClientesEditar
    }, {
        name: 'micrositios',
        path: '/admin/micrositios/', props: true,
        component: MicrositiosList
    }, {
        name: 'micrositiosEditar',
        path: '/admin/micrositio/:id', props: true,
        component: MicrositiosEditar
    }, {
        name: 'productos',
        path: '/admin/:id/products/', props: true,
        component: ProductosList
    }, {
        name: 'productosEditar',
        path: '/admin/product/:id', props: true,
        component: ProductosEditar
    }, {
        name: 'servicios',
        path: '/admin/:id/servicios/', props: true,
        component: ServiciosList
    }, {
        name: 'serviciosEditar',
        path: '/admin/servicio/:id', props: true,
        component: ServiciosEditar
    }, {
        name: 'users',
        path: '/admin/users/', props: true,
        component: UsersList
    }, {
        name: 'usersEditar',
        path: '/admin/user/:id', props: true,
        component: UsersEditar
    }, {
        name: 'categorias',
        path: '/admin/:id/categorias/', props: true,
        component: CategoriasList
    }, {
        name: 'categoriasEditar',
        path: '/admin/categoria/:id', props: true,
        component: CategoriasEditar
    }, {
        name: 'cliente-micrositio',
        path: '/admin/cliente-micrositio', props: true,
        component: ClienteMicrositioList
    }, {
        name: 'cliente-micrositioEditar',
        path: '/admin/cliente-micrositio/:id', props: true,
