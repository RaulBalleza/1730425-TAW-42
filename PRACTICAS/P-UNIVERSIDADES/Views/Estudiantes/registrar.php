			...
			<div class="container col-sm-12 col-md-10 col-lg-10 col-xl-7">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form action="?controller=Producto&action=guardar" method="POST" data-parsley-validate> <!-- Agregar id para notificación overhang -->
							...
							<div class="form-row">
                                ...
                                <div class="form-group col-sm-4">
									<label for="color">Color</label><label class="text-danger">*</label>
									<input type="text" name="txtColor" class="form-control" id="color" placeholder="Color del producto" data-parsley-pattern="^[A-zÀ-ú ]+$" data-parsley-length="[2, 14]" data-parsley-trigger="keyup" required>
								</div>
							</div>
