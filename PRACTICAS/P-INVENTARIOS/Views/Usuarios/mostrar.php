<div class="container">
    ...
    <div class="row mt-4 mb-4">
        <div class="col-6">
            <div class="text-left">
                <a href="?controller=Usuario&action=registrar" class="btn btn-sm btn-outline-primary"><i class="fa fa-fw fa-plus-circle"></i> Registrar un nuevo usuario</a>
            </div>
        </div>
        <div class="col-6">
            <div class="text-right">
                <i class="fa fa-fw fa-globe"></i><strong> Buscar un usuario</strong>
            </div>
        </div>
    </div>
            ...
            <tbody>
                <?php foreach ($usuarios as $usuario) { ?>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="?controller=Usuario&&action=actualizarUsuario&&id=<?php echo $usuario->getId() ?>" class="edit">
                                <div class="text-center"><i class="fas fa-pen"></i> Editar</div>
                            </a>
                            <a href="?controller=Usuario&&action=eliminar&&id=<?php echo $usuario->getId() ?>" class="trash">
