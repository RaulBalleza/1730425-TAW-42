...
class ProductoControlador{
  ...
  function guardar(){
    $producto= new Producto( null, $_POST['txtNombre'], $_POST['txtDescripcion'], $_POST['txtColor'], $_POST['txtCompra'], $_POST['txtVenta'], $_POST['txtCategoria'] );
  ...
  function actualizar(){
		$producto = new Producto( $_POST["txtId"], $_POST['txtNombre'], $_POST['txtDescripcion'], $_POST['txtColor'], $_POST['txtCompra'], $_POST['txtVenta'], $_POST['txtCategoria'] );
